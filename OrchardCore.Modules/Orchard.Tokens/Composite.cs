...
namespace Orchard.Tokens
{
    ...
    {
        protected readonly IDictionary<string, object> _props = new Dictionary<string, object>(StringComparer.OrdinalIgnoreCase);
        ...
        public override bool TryGetIndex(GetIndexBinder binder, object[] indexes, out object result)
        {
            ...
            if (_props.TryGetValue(index.ToString(), out result))
            {
                return true;
            }
        ...
        public override bool TrySetIndex(SetIndexBinder binder, object[] indexes, object value)
        {
            ...
            _props[indexes[0].ToString()] = value;
            return true;
        }
